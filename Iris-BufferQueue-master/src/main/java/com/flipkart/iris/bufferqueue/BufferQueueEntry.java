 ...
 * Entry has following format :<br/>
 * -----------------------------------------------------------------<br/>
 * | offset		|	datalength		|	checksum	|	data		|<br/>
 * -----------------------------------------------------------------<br/>
 * 
 * offset (8 byte): <br/>
 * 			CLAIMED 	: 0<br/>
 * 			PUBLISHED 	: rand no.<br/>
 * 			CONSUMED	: -1<br/>
 * data length (4 byte)<br/>
 * checksum (4 byte) : checksum of stored data<br/> 
 * data : rest bytes contains data <br/>
 *  
